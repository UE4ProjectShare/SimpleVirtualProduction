...
#include "SimpleVPUtilitiesEditorSettings.generated.h"

/**
 * Virtual Production utilities settings for editor
 */
UCLASS(config=SimpleVPUtilities)
class SIMPLEVPUTILITIESEDITOR_API USimpleVPUtilitiesEditorSettings : public UObject
{
	GENERATED_BODY()

public:
	USimpleVPUtilitiesEditorSettings();

	//TSoftClassPtr https://blog.csdn.net/qq_45777198/article/details/107838444
