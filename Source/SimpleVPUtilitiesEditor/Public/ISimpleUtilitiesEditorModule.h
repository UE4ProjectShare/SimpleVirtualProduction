...
class SIMPLEVPUTILITIESEDITOR_API ISimpleVPUtilitiesEditorModule : public IModuleInterface
{
public:
	/**
	 ...
	 */
	static ISimpleVPUtilitiesEditorModule& Get()
	{
		static const FName ModuleName = "SimpleVPUtilitiesEditor";
		return FModuleManager::LoadModuleChecked<ISimpleVPUtilitiesEditorModule>(ModuleName);
	};
