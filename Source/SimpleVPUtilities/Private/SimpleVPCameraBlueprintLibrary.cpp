...
#include "SimpleVPCameraBlueprintLibrary.h"
...
FSimpleVPCameraRigSpawnParams::FSimpleVPCameraRigSpawnParams()
	: bUseWorldSpace(true)
	, bUseFirstPointAsSpawnLocation(false)
	, LinearApproximationMode(ESimpleVPCameraRigSpawnLinearApproximationMode::None)
	, LinearApproximationParam(1.f)
{
}

ACameraRig_Rail* USimpleVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints(UObject* WorldContextObject,
                                                                            const TArray<FTransform>& Points, ESplinePointType::Type InterpType)
{
	UWorld* World = WorldContextObject ? WorldContextObject->GetWorld() : nullptr;
	if (World == nullptr)
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints - Unable to get world"));
		return nullptr;
	}

	if (Points.Num() <= 1)
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnDollyTrackFromPoints - Too few points"));
		return nullptr;
	}
...
ACameraRig_Rail* USimpleVPCameraBlueprintLibrary::SpawnDollyTrackFromPointsSmooth(UObject* WorldContextObject,
	const TArray<FTransform>& Points, ESplinePointType::Type InterpType)
{
...
ACameraRig_Rail* USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromActors(UObject* WorldContextObject,
	const FTransform& RigTransform, const TArray<AActor*>& Actors, const FSimpleVPCameraRigSpawnParams& Params)
{
...
ACameraRig_Rail* USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromPoints(UObject* WorldContextObject,
	const FTransform& RigTransform, const TArray<FVector>& Points, const FSimpleVPCameraRigSpawnParams& Params)
{
	...
	if (World == nullptr)
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Unable to get world"));
		return CameraRig;
	}

	if (Points.Num() <= 1)
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Too few points"));
		return CameraRig;
	}
	...
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("UVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Failed to spawn camera rig"));
		return CameraRig;
	}
	...
	{
		UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromPoints - Failed to get Spline"));
		return CameraRig;
	}
	...
	if (Params.LinearApproximationMode != ESimpleVPCameraRigSpawnLinearApproximationMode::None)
	{
		...
		if (Params.LinearApproximationMode == ESimpleVPCameraRigSpawnLinearApproximationMode::IntegrationStep)
		{
...
ACameraRig_Rail* USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromSelectedActors(UObject* WorldContextObject,
	const FTransform& RigTransform, const FSimpleVPCameraRigSpawnParams& Params)
{
#if WITH_EDITOR
	if (GEditor != nullptr)
	{
	...
	UE_LOG(LogSimpleVPUtilities, Warning, TEXT("USimpleVPCameraBlueprintLibrary::SpawnCameraRigFromSelectedActors - Only callable from editor"));
	return nullptr;
}
